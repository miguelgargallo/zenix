...
description: "In this article, we will be creating a chatbot using TensorFlow and a dataset of pirate-related phrases."
...
In this article, we will be creating a chatbot using TensorFlow and a dataset of pirate-related phrases. The chatbot will be able to respond to various inputs related to pirates, such as questions about pirate history or requests for pirate jokes.
...
Here is the code: [View on GitHub](https://github.com/miguelgargallo/jupyter-notebook/tree/main/03-tensorflow-pirates-chatbot)
